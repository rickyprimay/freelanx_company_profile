  ...
  return (
    <section id="book" className="lg:pt-25 pt-15">
      <div className="container">
        <div className="relative mx-auto grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-center lg:text-left lg:px-12.5 py-7.5 px-8 rounded-[20px] bg-gradient-to-r from-[#00455F] to-[#00A5E3] text-white items-center overflow-hidden">
          <Image
          ...
          <div className="relative z-10 mt-5 lg:mt-0 grid grid-cols justify-center lg:justify-end gap-4">
            <a
              href="#"
