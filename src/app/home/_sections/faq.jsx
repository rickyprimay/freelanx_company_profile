...
const faqList = [
  {
    ...
    answer: "Tentu! Kami menyediakan paket custom development, di mana Anda bisa menentukan fitur sesuai kebutuhan bisnis Anda. Kami akan melakukan analisis untuk memberikan solusi terbaik."
  },
  {
    question: "Berapa lama waktu pengerjaan proyek?",
    answer: "Waktu pengerjaan tergantung pada kompleksitas proyek. Untuk aplikasi standar, estimasi waktu sekitar 2-4 minggu, sedangkan proyek yang lebih kompleks dapat memakan waktu lebih lama."
  },
  {
    question: "Apakah ada layanan after-sales atau maintenance?",
    answer: "Ya! Kami menyediakan layanan maintenance & support untuk memastikan aplikasi tetap berjalan optimal, aman, dan selalu up-to-date."
  },
  {
    question: "Apakah Freelanxx hanya melayani perusahaan atau juga individu?",
    answer: "Kami melayani perusahaan, startup, UMKM, hingga individu yang membutuhkan solusi digital profesional."
  },
  {
    question: "Apakah konsultasi awal dikenakan biaya?",
    answer: "Tidak! Konsultasi awal 100% gratis. Kami akan membantu memahami kebutuhan Anda sebelum memulai proyek."
  },
  {
    question: "Bagaimana cara memulai kerja sama dengan Freelanxx?",
    answer: "Mudah! Cukup hubungi kami melalui WhatsApp, email, atau DM sosial media. Tim kami siap membantu Anda memulai transformasi digital bisnis Anda! 🚀"
  }
];
  ...
  return (
    <section id="faqs" className="lg:pt-[25px] pt-[15px]">
      <div className="container">
        ...
        <div className="p-12.5 rounded-[15px] bg-gradient-to-r from-[#00455F] to-[#00A5E3] text-center my-auto relative overflow-hidden">
            <Image src={BgShape} alt="Background Shape" layout="fill" objectFit="cover" className="absolute inset-0 opacity-50" />
